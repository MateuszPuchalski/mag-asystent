...
**Blizna 0.484.6: oczy były, wzroku nie było.** Od 0.330.0 do 0.484.5 żadne
...
Podgląd w panelu działał, bo chodzi końcówką API. Od 0.484.6 Copilot idzie tą
...
**Przyjęcie wraca jednym kliknięciem (0.492.0).** Właściciel zapytał, jak
...
| Paczka nieodebrana jako osobny byt | formularz **wycofany** w 0.451.0, przyjęcie **działa** od 0.492.0 | `przyjmijNieodebrana`, przycisk przy wierszu paczek klienta |
