...
| Notatka do dostawy w mierze i alarmie | **działa** od 0.366.0 | wyłączona w 0.361.0 przez uzasadnienie wzięte z `conversation_event`; `delivery_note` ma jedną odpowiedź, a brak odpowiedzi wstrzymuje domknięcie dostawy |
