    ...
    extend: {
      colors: {
        ...
        /* Statusy rozmowy z §7. Para tło–tekst, żeby plakietki nie dobierało
           ...
           Do 0.157.0 stało tu pięć par na osiem statusów — barwy czekały na
           wartość, której serwer jeszcze nie oddawał. Trzy dochodzące
           (odłożone, zamknięte, spam) są celowo CICHSZE od pozostałych:
           opisują rozmowy, przy których nie ma dziś pracy, a plakietka
           krzycząca z każdego wiersza uczy ignorowania plakietek. */
        stan: {
          ...
          "odlozone": "#ede9fe", "odlozone-tekst": "#5b21b6",
          "zamkniete": "#e2e8f0", "zamkniete-tekst": "#475569",
