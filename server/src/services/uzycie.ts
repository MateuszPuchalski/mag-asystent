...
const AUTOMATY = new Set([
  ...
  "copilot_auto_szkic_sufit", "ean_conflict_autoresolved", "http_rejected", "login_failed",
  "privileged", "read_model_po_imporcie", "wiedza_automat_przebieg", "zwrot_rabat_automat_blad",
