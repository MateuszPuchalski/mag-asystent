...
export const KLUCZE: readonly Klucz[] = [
  ...
  { klucz: "MSSQL_BUFFER_EXPR", grupa: "subiekt", kto: "zaawansowane",
    opis: "Wyrażenie SQL rozpoznające dokument w buforze." },
  ...
  { klucz: "DOK_TYP_FZ", grupa: "magazyn", kto: "zaawansowane", opis: "Kod dok_Typ faktury zakupu." },
  { klucz: "DOK_TYP_PZ", grupa: "magazyn", kto: "zaawansowane", opis: "Kod dok_Typ przyjęcia zewnętrznego." },
  { klucz: "DOK_TYP_ZD", grupa: "magazyn", kto: "zaawansowane", opis: "Kod dok_Typ zamówienia do dostawcy." },
  { klucz: "DOK_TYP_FS", grupa: "magazyn", kto: "zaawansowane", opis: "Kod dok_Typ faktury sprzedaży." },
  { klucz: "DOK_TYP_PA", grupa: "magazyn", kto: "zaawansowane", opis: "Kod dok_Typ paragonu." },
  { klucz: "DOK_TYP_MM", grupa: "magazyn", kto: "zaawansowane", opis: "Kod dok_Typ przesunięcia międzymagazynowego." },
  ...
  { klucz: "ALLEGRO_ZDJECIA_PX", grupa: "allegro", kto: "zaawansowane",
    opis: "Szerokość miniatury zdjęcia oferty w pikselach." },
  { klucz: "ALLEGRO_ZDJECIA_MAX_KB", grupa: "allegro", kto: "zaawansowane",
    opis: "Największe zdjęcie oferty, jakie serwer pobierze." },
  { klucz: "ALLEGRO_ZDJECIA_CACHE_MB", grupa: "allegro", kto: "zaawansowane",
    opis: "Rozmiar pamięci podręcznej zdjęć ofert." },
  { klucz: "ALLEGRO_ZDJECIA_TIMEOUT_MS", grupa: "allegro", kto: "zaawansowane",
    opis: "Limit czasu pobrania zdjęcia oferty." },
  { klucz: "ALLEGRO_ZDJECIA_BLAD_TTL_MIN", grupa: "allegro", kto: "zaawansowane",
    opis: "Ile minut nie ponawiać zdjęcia po błędzie." },
  ...
  { klucz: "COPILOT_AUTO_MS", grupa: "copilot", kto: "zaawansowane",
    opis: "Takt automatycznych szkiców w milisekundach." },
  { klucz: "COPILOT_AUTO_NA_PRZEBIEG", grupa: "copilot", kto: "zaawansowane",
    opis: "Ile szkiców na jeden przebieg taktu." },
  { klucz: "COPILOT_AUTO_KLASYFIKACJA_MS", grupa: "copilot", kto: "zaawansowane",
    opis: "Takt automatycznego rozpoznania w milisekundach." },
  ...
  { klucz: "WIEDZA_AUTOMAT_MS", grupa: "copilot", kto: "zaawansowane",
    opis: "Takt automatu wiedzy w milisekundach." },
  ...
  { klucz: "ZDJECIA_CACHE_MB", grupa: "zdjecia", kto: "zaawansowane",
    opis: "Rozmiar pamięci podręcznej zdjęć kartotek." },
  { klucz: "ZDJECIA_TTL_H", grupa: "zdjecia", kto: "zaawansowane",
    opis: "Ile godzin trzymać zdjęcie w pamięci podręcznej." },
  { klucz: "ZDJECIA_BRAK_TTL_H", grupa: "zdjecia", kto: "zaawansowane",
    opis: "Po ilu godzinach pytać znowu o kartotekę bez zdjęcia." },
  { klucz: "ZDJECIA_BLAD_TTL_MIN", grupa: "zdjecia", kto: "zaawansowane",
    opis: "Ile minut nie ponawiać po błędzie źródła zdjęć." },
