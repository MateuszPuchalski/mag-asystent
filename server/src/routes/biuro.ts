...
export async function biuroRoutes(app: FastifyInstance) {
  ...
  for (const [plik, mime] of [["wms.js", "text/javascript"], ["wms-carts.js", "text/javascript"], ["wms-stock-work.js", "text/javascript"], ["wms.css", "text/css"],
    ["wms-packing.js", "text/javascript"], ["wms-handoff.js", "text/javascript"], ["wms-inbound.js", "text/javascript"], ["wms-putaway.js", "text/javascript"], ["wms-photos.js", "text/javascript"], ["biuro-theme.js", "text/javascript"], ["biuro-theme.css", "text/css"]]) {
