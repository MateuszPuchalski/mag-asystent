...
|---|---|---|
| `:core` | czysta logika JVM: klasyfikacja skanów, walidacja lokalizacji, DTO REST, model nawigacji, model wyjątków (które typy wymagają zdjęcia), bufor offline — **55 testów** | działa bez Android SDK (`./gradlew :core:test`) |
