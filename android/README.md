...
|---|---|---|
| `:core` | czysta logika JVM: klasyfikacja skanów, walidacja lokalizacji, DTO REST, model nawigacji, model wyjątków (które typy wymagają zdjęcia), kontekst przyklejony — **76 testów** | działa bez Android SDK (`./gradlew :core:test`) |
